...
namespace Transbank.NET.sample.certificates
{
    public class CertOneclick
    {
        ...
        internal static Dictionary<string, string> certificate()
        {
            ...
            certificate.Add("public_cert", certFolder + "\\certificates\\597020000547\\tbk.pem");

            /** Ejemplo de Ruta de Certificado de Salida */
            certificate.Add("webpay_cert", certFolder + "\\certificates\\597020000547\\597020000547.pfx");

            /** Ejemplo de Password de Certificado de Salida */
            certificate.Add("password", "transbank123");

            /** Codigo Comercio */
            certificate.Add("commerce_code", "597020000547");
